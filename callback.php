...
if (isset($_GET['code'])) {
    ...
    if ($accessToken) {
        ...
        if (isset($profileData['userId'])) {
            ...
            $redirectUri = "changrutchayothin://changrutchayothin.com/authCreateLineAcc?sessionToken=" . urlencode($sessionToken);
            ...
            if (!empty($existingUser)) {
                ...
                echo '<a href="changrutchayothin://changrutchayothin.com/authCreateLineAcc">คลิกที่นี่เพื่อกลับไปยังแอป</a>';
